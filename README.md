...
- The executive report (Item 3 of the assignment) is not included in this script - it's a separate written deliverable, to be built from the numbers and segment names exported here.